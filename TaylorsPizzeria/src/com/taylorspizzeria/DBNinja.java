...
public final class DBNinja {
	...
	public static String getCustomerName(int CustomerID) throws SQLException, IOException
	{
		/*
		...
		connect_to_db();
		String ret = "";
		String query = "Select FName, LName From Customer WHERE CustomerID=" + CustomerID + ";";
	...
	public static void printToppingPopReport() throws SQLException, IOException
	{
        ...
        String query = "SELECT * FROM ToppingPopularity ORDER BY Topping ASC;";

        ResultSet result = statement.executeQuery(query);

        while (result.next()) {
            System.out.println("|Topping: "+
                    result.getString(1) + " |ToppingCount: " + result.getString(2));
        }//while end
	...
	public static void printProfitByPizzaReport() throws SQLException, IOException
	{
        ...
        String query = "SELECT * FROM ProfitByPizza ORDER BY LastOrderDate ASC;";

        ResultSet result = statement.executeQuery(query);

        while (result.next()) {
            System.out.println("PizzaSize: "+
                    result.getString(1) + " |PizzaCrust " + result.getString(2) + " |Profit: "
                    + result.getString(3)+ " |Date: " + result.getString(4));
        }//while end
	...
	public static void printProfitByOrderType() throws SQLException, IOException
	{
        ...
        String query = "SELECT * FROM ProfitByOrderType ORDER BY OrderMonth ASC;";

        ResultSet result = statement.executeQuery(query);

        while (result.next()) {
            System.out.println("OrderType: "+
                    result.getString(1) + " |OrderMonth: " + result.getString(2) + "|TotalOrderPrice: "
                    + result.getString(3)+ " |TotalOrderCost: " + result.getString(4)+ " |Profit: "
                    + result.getString(5));
        }//while end
        
        conn.close();
		//DO NOT FORGET TO CLOSE YOUR CONNECTION	
	}// END printProfitByOrderType
