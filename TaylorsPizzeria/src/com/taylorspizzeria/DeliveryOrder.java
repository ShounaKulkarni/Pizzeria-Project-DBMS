...
public class DeliveryOrder extends Order
{
	...
	public DeliveryOrder(int orderID, int CustomerID, String date, double custPrice, double busPrice, int isComplete, String address) 
	{
		super(orderID, CustomerID, DBNinja.delivery, date, custPrice, busPrice, isComplete);
